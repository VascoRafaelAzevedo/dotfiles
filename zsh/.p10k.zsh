# Generated by Powerlevel10k configuration wizard on 2025-10-11 at 18:57 CEST.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Gruvbox aqua/blue for directory.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#83a598'
  # Strip ~/ prefix; hide segment entirely when at home directory.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#b8bb26}'    # Gruvbox bright green
      local   modified='%F{#fabd2f}'    # Gruvbox bright yellow
      local conflicted='%F{#fb4934}'    # Gruvbox bright red
    else
    ...
    if (( VCS_STATUS_NUM_STAGED || VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_UNTRACKED || (VCS_STATUS_HAS_UNSTAGED == -1) )); then
      res+=" ${modified}●"
    fi
